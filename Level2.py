...
class Mob(pygame.sprite.Sprite):
    def __init__(self, spawn_x, spawn_y):
        ...
        self.image = pygame.transform.scale(pygame.image.load('assets/krill.png').convert_alpha(), (100, 100))
...
class Elite(pygame.sprite.Sprite):
    def __init__(self, spawn_x, spawn_y, spawn_type):
        ...
        self.speed = 10
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.transform.scale(pygame.image.load('assets/dolphin.png').convert_alpha(), (100, 100))
        self.rect = self.image.get_rect()
...
class Boss(pygame.sprite.Sprite):
    def __init__(self, spawn_x, spawn_y):
        ...
        self.hp = 3000
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.transform.scale(pygame.image.load("assets/whale.png"), (300, 350))
        self.rect = self.image.get_rect()
...
class Tornado(pygame.sprite.Sprite):
    def __init__(self, x, y, angle=90):
        pygame.sprite.Sprite.__init__(self)
        self.spritesheet = pygame.image.load('assets/bubble.png')
...
class Cloud(pygame.sprite.Sprite):
    def __init__(self, x, y, angle=90):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.transform.scale(pygame.image.load("assets/bubble.png"), (50, 50))
        self.rect = self.image.get_rect()
        self.rect.top = y
        self.rect.centerx = x
        self.speed = 10
...
class Gameplay2:
    ...
    def start_level2(self):
        ...
        mobs_music = 'assets/underwater_mobs.mp3'
        boss_music = 'assets/underwater_boss.mp3'
        ...
        background = pygame.transform.scale(pygame.image.load('assets/underwater.png').convert(), (self.width, self.height))
    ...
    def game_over_screen(self, text, score, width, height, screen, weapon_selected, volume):
        ...
        while running:
            screen.fill((0, 0, 0))
            background = pygame.transform.scale(pygame.image.load('assets/underwater.png').convert(), (width, height))
    ...
    def update_file(self, new_score, weapon_selected):
        ...
        with open('assets/info.txt', 'r') as file:
            ...
            with open('assets/info.txt', 'w') as file:
                file.write(f"{score1},{score2},{current_score},{current_gold},{weapon_selected}")
